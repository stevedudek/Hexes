...
class HexServer(object):
    def __init__(self, hex_model, hex_simulator, args):
        self.args = args
        self.hex_model = hex_model
        self.hex_simulator = hex_simulator
        self.runner = None
        self.running = False
    ...
    def _create_services(self):
        ...
        self.runner = ShowRunner(model=self.hex_model,
                                 simulator=self.hex_simulator,
                                 max_showtime=args.max_time,
                                 channel=self.hex_simulator.get_channel())
...
if __name__ == '__main__':
    ...
    for i in range(NUM_CHANNELS):
        ...
        channels.append(HexServer(hex_model=hex_model, hex_simulator=hex_simulator, args=args))
